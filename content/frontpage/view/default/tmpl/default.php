...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Oman El&auml;m&auml;ni Luoja - Henkisi&auml; ja k&auml;yt&auml;nn&ouml;llisi&auml; v&auml;lineit&auml; el&auml;m&auml;n tietoiseen luomiseen">
    <meta name="keywords" content="manifestointi, unelmat, henkisyys, pelko">
			...
			<table align="center" border="0" cellpadding="0" cellspacing="0" class="uutiskirje" height="65" width="800">
				<tbody>
					<tr>
						...
						<div class="mc-field-group"><label for="mce-EMAIL">S&auml;hk&ouml;postiosoite </label><input class="required email" id="mce-EMAIL" name="EMAIL" type="text" /></div>
						...
						<div class="clear"><input class="button" id="mc-embedded-subscribe" name="subscribe" type="submit" value="Tilaa uutiskirje" /></div>
						</form>
						</div>
...
function mce_init_form(){
    jQuery(document).ready( function($) {
      ...
      options = { url: 'http://hiljaisuudenpuutarha.us5.list-manage2.com/subscribe/post-json?u=cbfbabcedcb7cc81bbba3eca3&id=e235d172b9&c=?', type: 'GET', dataType: 'json', contentType: "application/json; charset=utf-8",
