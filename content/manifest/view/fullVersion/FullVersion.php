...
class SomeViewFullVersion extends SomeView {
  ...
  //   metodissa arvoksi FullVersion, joka tarkoittaa tiedostoa tmpl/FullVersion.php

  public function display($tmpl = 'FullVersion') {
