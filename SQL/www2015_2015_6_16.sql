...
--
-- Host: 127.0.0.1
-- Generation Time: 16.06.2015 klo 13:08
-- Palvelimen versio: 5.6.24
-- PHP Version: 5.6.8
...
--
-- Rakenne taululle `hasrights`
--

CREATE TABLE IF NOT EXISTS `hasrights` (
...
--
-- Vedos taulusta `hasrights`
--

INSERT INTO `hasrights` (`user_id`, `product_id`, `date_from`, `date_to`) VALUES
(2, 1, NULL, NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='Tuotetaulu';

--
-- Vedos taulusta `product`
--

INSERT INTO `product` (`id`, `Nimi`, `description`) VALUES
(1, 'Manifestointipiiri', 0);
...
--
-- Indexes for table `hasrights`
--
ALTER TABLE `hasrights`
